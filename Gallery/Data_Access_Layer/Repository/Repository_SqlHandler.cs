            ...
            try
            {
                ...
                else if (Repository_Class.Repository.SQLMethod == "SP")
                {
                    if (Repository_Class.Repository.SQLCommand == "Select")
                    {
                        ...
                        if (Repository_Class.Repository.SQLParameterValue != null)
                        {
                            Repository_Class.Repository.Command.Parameters.Add(new SqlParameter(Repository_Class.Repository.SQLParameterName, Repository_Class.Repository.SQLParameterValue));
                        }   
                        da.SelectCommand = Repository_Class.Repository.Command;
                        ds.Clear();
                        da.Fill(ds);
                ...
                Repository_Class.Repository.SQLParameterValue = null;
                return ds;
            }
            catch (Exception)
            {
